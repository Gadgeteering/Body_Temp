...
// Create the MAX30205 temperature sensor object
MAX30205 tempsensor = MAX30205();
...
void setup() {
  ...
  if (!tempsensor.begin(0x48)) {
    Serial.println("Couldn't find MAX30205! Check your connections and verify the address is correct.");
    while (1);
  }
  Serial.println("Found MAX30205!");
...
void loop() {
  ...
  Serial.println("Wake up MAX30205");
  tempsensor.wake();
  ...
  Serial.println("Shutting down MAX30205");
